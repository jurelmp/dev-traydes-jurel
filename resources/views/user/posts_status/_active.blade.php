<div>
    ...
    <ul class="nav nav-tabs nav-justified">
        <li role="presentation" class="active"><a href="{{ url('user/my-posts?status=active') }}">Active</a></li>
        <li role="presentation"><a href="#">Expired</a></li>
        <li role="presentation"><a href="{{ url('user/my-posts?status=trashed') }}">Trashed</a></li>
    </ul>
